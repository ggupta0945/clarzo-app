...
import { sectors, gptResponses, type Company, type Sector } from '@/app/discover/data'

// Dashboard version of the Discover page. Identical content to /discover but:
// - No CTA banners (user is already logged in)
// - No auth-detection needed (dashboard layout guards this route)
// - No standalone header/nav (provided by DashboardNav in the layout)
...
export default function DashboardDiscoverPage() {
  ...
  return (
    <div className="min-h-screen bg-[#040f0a] text-[#e4f0e8]">
      {/* Page header */}
      <div className="border-b border-[#1a4a2e] px-4 py-6 sm:px-8">
        <h1
        ...
        <p className="mt-1 text-sm text-[#88b098]">
          Explore sectors, research companies, and make informed decisions.
        </p>
        <div className="mt-3 inline-flex items-center gap-2 rounded-lg border border-[#1a4a2e] bg-[#071a10] px-3 py-1.5 text-xs text-[#88b098]">
      ...
      <div className="px-4 py-6 sm:px-8">
        ...
        {/* Breadcrumb */}
        <div className="mb-5 flex flex-wrap items-center gap-2 text-xs text-[#88b098]">
          <button
            onClick={showSectors}
    ...
    <div className="pb-20">
      ...
      {sector.cos.length === 0 ? (
        <div className="rounded-2xl border border-[#1a4a2e] bg-[#071a10] py-10 text-center text-sm text-[#88b098]">
          Company data for this sector is coming soon. We&apos;re adding BSE-listed companies every week.
        </div>
      ) : (
            ...
            >
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{ background: COMPANY_AVATAR_COLORS[i % COMPANY_AVATAR_COLORS.length] }}
                >
              ...
              <p className={`text-right text-sm font-semibold ${c.up ? 'text-[#34d399]' : 'text-[#ef4444]'}`}>
                {c.change}
              </p>
  ...
  return (
    <div className="pb-20">
      ...
      <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
        ...
        <Metric label="Today" value={company.change} color={company.up ? '#34d399' : '#ef4444'} />
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-[#1a4a2e] bg-[#071a10] p-6">
          ...
          <div className="mb-5">
            <h4 className="mb-2 text-sm font-semibold text-[#34d399]">✦ Strengths</h4>
            <ul className="space-y-2">
              {company.pros.map((p) => (
                <li
                  key={p}
          ...
          <div>
            <h4 className="mb-2 text-sm font-semibold text-[#ef4444]">✦ Risks</h4>
            <ul className="space-y-2">
              {company.cons.map((p) => (
                <li
                  key={p}
